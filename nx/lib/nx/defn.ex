defmodule Nx.Defn do
  ...
  `input` is the tensor (or container of tensors) to save for recomputation.
  Variables captured via closure (e.g., weights) are always available and do
  not need to be passed as inputs.
