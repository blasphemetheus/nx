...
3. **PR C -> split into three single-topic fork drafts (bundled fork PR 14 closed):**
   ...
   - C3 reshape :auto ArgumentError -> MERGED upstream (1819). Follow-up from pol review note: https://github.com/elixir-nx/nx/pull/1820 adds test coverage for revectorize·s existing multiple-:auto guard (verified guard already covers all three combos).
